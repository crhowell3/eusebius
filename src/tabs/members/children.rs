...
pub fn children() -> Html {
    ...
    let new_child = use_state(|| Child::new());

    let handle_child_change = {
        ...
        Callback::from(move |e: Event| {
            ...
            let mut updated = (*new_child).clone();

            match name.as_str() {
                "family_id" => updated.family_id = value,
                _ => {}
            }
            new_child.set(updated);
        })
    };
        ...
        <div>
            ...
            <div class="form">
                <input
                    ...
                    min=1
                    step=1
                    value={(*new_child).clone().family_id}
                    onchange={handle_child_change.clone()}
                />
